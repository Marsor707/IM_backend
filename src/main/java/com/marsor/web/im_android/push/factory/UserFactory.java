...
import com.marsor.web.im_android.push.bean.db.UserFollow;
...
//        return Hib.query(session -> (User)session.save(user));
     ...
     * @return 查询到的用户集合 如果name为空 则返回最近的数据
     */
    @SuppressWarnings("unchecked")
