...
public class PushDispatcher {
    private static final String appId = "tLVmxEw95s5EE810IeNg85";
    private static final String appKey = "7lbnZxhJMM9djClXKpPyI4";
    private static final String masterSecret = "9BRQhIVktL6eypQFgGqY86";
